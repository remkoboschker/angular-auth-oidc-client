...
describe('OidcSecurityStateValidationService', () => {
    ...
    it('should return invalid result if validateStateFromHashCallback is false', async(() => {
        ...
        stateValidationService.validateState('', new JwtKeys()).then((state) => {
    ...
    it('access_token should equal result.access_token and is valid if response_type is "id_token token"', async(() => {
        ...
        stateValidationService.validateState(
            {
    ...
    it('should return invalid result if validate_signature_id_token is false', async(() => {
        spyOn(oidcSecurityValidation, 'validateStateFromHashCallback').and.returnValue(true);
        config.response_type = 'id_token token';
        spyOn(tokenHelperService, 'getPayloadFromToken').and.returnValue('decoded_id_token');
    ...
    it('should return invalid result if validate_id_token_nonce is false', async(() => {
        spyOn(oidcSecurityValidation, 'validateStateFromHashCallback').and.returnValue(true);
        config.response_type = 'id_token token';
        spyOn(tokenHelperService, 'getPayloadFromToken').and.returnValue('decoded_id_token');
        spyOn(oidcSecurityValidation, 'validate_signature_id_token').and.returnValue(true);
    ...
    it('should return invalid result if validate_required_id_token is false', async(() => {
        spyOn(oidcSecurityValidation, 'validateStateFromHashCallback').and.returnValue(true);
    ...
    it('should return invalid result if validate_id_token_iat_max_offset is false', async(() => {
        spyOn(oidcSecurityValidation, 'validateStateFromHashCallback').and.returnValue(true);
    ...
    it('should return invalid result if validate_id_token_iss is false', async(() => {
        spyOn(oidcSecurityValidation, 'validateStateFromHashCallback').and.returnValue(true);
    ...
    it('should return invalid result if validate_id_token_aud is false', async(() => {
        spyOn(oidcSecurityValidation, 'validateStateFromHashCallback').and.returnValue(true);
    ...
    it('should return invalid result if validate_id_token_exp_not_expired is false', async(() => {
        spyOn(oidcSecurityValidation, 'validateStateFromHashCallback').and.returnValue(true);
    ...
    it('Reponse is invalid if validate_id_token_at_hash is false', async(() => {
        spyOn(oidcSecurityValidation, 'validateStateFromHashCallback').and.returnValue(true);
        spyOn(tokenHelperService, 'getPayloadFromToken').and.returnValue('decoded_id_token');
        spyOn(oidcSecurityValidation, 'validate_signature_id_token').and.returnValue(true);
        spyOn(oidcSecurityValidation, 'validate_id_token_nonce').and.returnValue(true);
    ...
    it('should return valid result if validate_id_token_iss is false and iss_validation_off is true', async(() => {
